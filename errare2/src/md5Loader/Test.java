...
public class Test implements Runnable{
	...
	public static void main (String[] args) throws Exception {
		...
		GraphicalRep modelMD5 = mr.getGraphicalRep();
		PhysicalRep phys = new PhysicalRep(new Point(0,0,0), new Point(10,10,10));
		SettingRep re = new SettingRep(phys, modelMD5, 2);
		AABox md2BB = new AABox(modelMD5.getGraphicalBoundaries());
		AABox md2BB2 = new AABox(modelMD5.getGraphicalBoundaries());
