...
public class MouseHelper implements MouseListener, MouseMotionListener, MouseWheelListener
{
	...
	private boolean middle_click_done;
	private boolean right_click_done;
	private MouseEvent eleft, eright, emiddle;
    ...
    */
	...
	public void mouseClicked(MouseEvent e) {
		if(!e.isConsumed()){
			...
			if(toButton(e)==MouseEvent.BUTTON2){
...
//	MouseMotionListener 
	public void mouseDragged(MouseEvent e) 
	{
		if(!e.isConsumed()){
			...
			}else if(toButton(e)==MouseEvent.BUTTON2){
				middle_click_done=true;
				emiddle=e;
			}
