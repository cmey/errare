...
public abstract class GraphicalRep{
	...
	protected static Hashtable<Integer,GraphicalRep> reptable = new Hashtable<Integer,GraphicalRep>();
	...
	/**
	 * A pointer to the physical representation corresponding to this model.
	 * @param pr
	 */
	 ...
	 * Simple Push before calling this, and pop after the draw.
	 * @param gl
	 */
