...
public class KeyboardHelper implements KeyListener{	
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		else if(e.getKeyCode() == KeyEvent.VK_F4 && !keys[e.getKeyCode()]){
			skybox_on = !skybox_on;
		}
		else if(e.getKeyCode() == KeyEvent.VK_F5 && !keys[e.getKeyCode()]){
		...
		else if(e.getKeyCode() == KeyEvent.VK_E && !keys[e.getKeyCode()]){
