...
public class GuiInfosPanel extends JPanel {
	
	/* Declaration of all images */
	
	private Image infosBackground;
	...
	public GuiInfosPanel(int width, int height, JInternalFrame mainWindow) {
	...
	private void drawInitialisation() {
		...
		infosBackground = (new ImageIcon("characterOptions/draw/infosBackground.png")).getImage();
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage(infosBackground, 0, 0, null);
